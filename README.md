...
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/giantswarm/agent/badge)](https://securityscorecards.dev/viewer/?uri=github.com/giantswarm/agent)

[Guide about how to manage an app on Giant Swarm](https://handbook.giantswarm.io/docs/dev-and-releng/app-developer-processes/adding_app_to_appcatalog/)

# agent chart

Giant Swarm offers a agent App which can be installed in workload clusters.
Here, we define the agent chart with its templates and default configuration.
